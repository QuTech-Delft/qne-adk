...
class TestAuthManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.auth_manager = AuthManager(config_dir=self.path, login_function=self.login_function,
    ...
    def test_load_token(self):
        with patch("adk.managers.auth_manager.read_json_file") as read_json_mock:
            ...
            loaded_token = self.auth_manager.load_token(self.host)
    ...
    def test_set_token(self):
        with patch("adk.managers.auth_manager.read_json_file") as read_json_mock, \
            ...
            self.auth_manager.set_token(self.host, token_to_set)
    ...
    def test_get_host_from_token(self):
        with patch("adk.managers.auth_manager.read_json_file") as read_json_mock:
            ...
            the_host = self.auth_manager.get_host_from_token(token)
            self.assertEqual(the_host, self.host)

            the_host = self.auth_manager.get_host_from_token('non_existing_token')
    ...
    def test_get_active_host(self):
        with patch.object(AuthManager, "_AuthManager__fetch_token") as fetch_token_mock:
            ...
            self.auth_manager.login(username=self.username, password=self.password, host=new_active_host)
    ...
    def test_get_password(self):
        with patch("adk.managers.auth_manager.read_json_file") as read_json_mock:
            ...
            password = self.auth_manager.get_password(self.host)
    ...
    def test_get_username(self):
        with patch("adk.managers.auth_manager.read_json_file") as read_json_mock:
            ...
            username = self.auth_manager.get_username(self.host)
